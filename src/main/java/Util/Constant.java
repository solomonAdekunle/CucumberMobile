...
public class Constant {
	...
	// Elements on Login Pop-up box
	 public static String LoginPopUpBox="div.login-modal";
	  ...
	  public static String Register_PostCode="postcode";
	  public static String Register_ContactNumber="mobile_phone";
	  ...
	  public static String Register_DepositLimitChooseType="deposit_limits";
	  public static String Register_DepositLimitChooseLimit="deposit_amount";
	  public static String Register_DepositLimitOtherAmount="input#edit-input-amount";
	  public static String Register_FreeBonusCheckBox="nobonus";
	  ...
	  public static String Reg_JackpotSliderBlock="div[class^='jackpots__jackpotsWrapper']";
